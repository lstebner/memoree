...
(function() {
  var DictionaryMenu, Memoree, Menu, dictionary_data,
  ...
  Menu = (function() {
    ...
    Menu.prototype.construct = function() {
      ...
      return this.container.html(this.content);
    };

    Menu.prototype.setup_overlay = function() {
      if (this.overlay) {
        return this.overlay;
      }
      this.overlay = $("<div class='overlay'></div>");
      return $(document.body).append(this.overlay);
    };

    Menu.prototype.setup_events = function() {
      this.container.on("click", (function(_this) {
        return function(e) {
          e.stopPropagation();
          return false;
  ...
  DictionaryMenu = (function(superClass) {
    extend(DictionaryMenu, superClass);

    function DictionaryMenu(opts) {
      this.opts = opts != null ? opts : {};
      DictionaryMenu.__super__.constructor.call(this, "#dictionary_menu_template", this.opts);
    }

    DictionaryMenu.prototype.setup_events = function() {
      DictionaryMenu.__super__.setup_events.apply(this, arguments);
      this.container.on("click", "li", (function(_this) {
        return function(e) {
          e.preventDefault();
          return $(e.currentTarget).toggleClass("selected");
        };
      })(this));
      return this.container.on("click", ".submit_btn", (function(_this) {
        return function(e) {
          e.preventDefault();
          return _this.apply_dictionary_selections();
        };
      })(this));
    };

    DictionaryMenu.prototype.apply_dictionary_selections = function() {
      return this.close();
    };
